...
# Introduction #great introduction, very clear problem and relevance
...
```{r message=FALSE}
Dbase <- lagosne_load(version = "1.087.1") dbase does not load, so the rest of the code does not work, cannot get plots to come up, or data to be shown
```
